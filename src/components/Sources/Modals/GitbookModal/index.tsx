...
import { gitbookSubSetTypes } from "../../../../utils/constants";
...
function GitbookModal({ onClose }: Props) {
  ...
  const emptyEntity = {
    id: uuidv4(),
    value: "",
    sourceType: SOURCE_TYPES.GITBOOK,
    subSetType: "",
    isScraped: false,
    placeholder: "",
    placeholderURL: "",
  ...
  return (
    <Box>
      <ModalBody p={0}>
        ...
        />
        <Description text={MODALS_DESCRIPTIONS.GITBOOK} />
        ...
        <Box px={1} mx={-1} flexGrow={1}>
          {entities.map((entity, index) => (
            <StyledInput
              ...
              subSetTypes={gitbookSubSetTypes}
