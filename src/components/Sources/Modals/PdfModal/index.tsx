...
import { pdfSubSetTypes } from "../../../../utils/constants";
import { EntityPayload, SOURCE_TYPES } from "../../../../utils/types";
import { validatePDFUrl } from "../../../../utils/urlValidation";
import {
  AddButton,
  BulkUploadButton,
  CancelButton,
...
const TwitterModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const validateEntities = () => {
    ...
    for (const entity of entities) {
      ...
      const isValidTwitterUrl = validatePDFUrl(entity.value);
    ...
    <Box>
      <ModalBody p={0}>
        <TitleWithIcon
          ...
          iconColor="icons.pdf"
        />
        <Description text={MODALS_DESCRIPTIONS.PDF} />
