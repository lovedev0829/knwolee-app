...
function TextToImageAgentCard() {
    ...
    function handleRunClick() {
        navigate("/knowleeagents", { state: { option: PANEL_OPTIONS.IMAGE } });
    }
            ...
            <Flex justifyContent="space-between" alignItems="center">
                <Box color={textColor}>
                    ...
                    <Text
                        ...
                        lineHeight="18px"
                    >
                        DALL-E 3 or SDXL? The choice is yours ✨
                    </Text>
                </Box>
            </Flex>
        </Box>
...
export default TextToImageAgentCard;
