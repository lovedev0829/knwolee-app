...
function ImageInterpreterAgentCard() {
    ...
    function handleRunClick() {
        navigate("/knowleeagents", { state: { option: PANEL_OPTIONS.IMAGE_INTERPRETER } });
    }
            ...
            <Flex justifyContent="space-between" alignItems="center">
                <Box color={textColor}>
                    ...
                    <Text
                        ...
                        lineHeight="18px"
                    >
                        Knowlee can see, give him an image 🖼️  
                    </Text>
                </Box>
            </Flex>
        </Box>
...
export default ImageInterpreterAgentCard;
