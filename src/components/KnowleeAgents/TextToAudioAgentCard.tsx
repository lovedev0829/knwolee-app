...
function TextToAudioAgentCard() {
    ...
    function handleRunClick() {
        navigate("/knowleeagents", { state: { option: PANEL_OPTIONS.AUDIO } });
    }
            ...
            <Flex justifyContent="space-between" alignItems="center">
                <Box color={textColor}>
                    ...
                    <Text
                        ...
                        lineHeight="18px"
                    >
                        Transform your text into captivating audio voiceovers 🗣️
                    </Text>
                </Box>
            </Flex>
        </Box>
...
export default TextToAudioAgentCard;
