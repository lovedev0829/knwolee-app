...
function CryptoInsightsAgentCard() {
    ...
    function handleRunClick() {
        navigate("/insight-creation/insight-generator");
    }
            ...
            <Flex justifyContent="space-between" alignItems="center">
                <Box color={textColor}>
                    ...
                    <Text
                        ...
                        lineHeight="18px"
                    >
                        Get insights for your favourite cryptocurrencies 💎
                    </Text>
                </Box>
            </Flex>
        </Box>
...
export default CryptoInsightsAgentCard;
