...
function TextToVideoAgentCard() {
    ...
    function handleRunClick() {
        navigate("/knowleeagents", { state: { option: PANEL_OPTIONS.VIDEO } });
    }
            ...
            <Flex justifyContent="space-between" alignItems="center">
                <Box color={textColor}>
                    ...
                    <Text
                        ...
                        lineHeight="18px"
                    >
                        Tell Knowlee what you need and get a video about it! 📹
                    </Text>
                </Box>
            </Flex>
        </Box>
...
export default TextToVideoAgentCard;
