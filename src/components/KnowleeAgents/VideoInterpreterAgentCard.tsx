...
function VideoInterpreterAgentCard() {
    ...
    function handleRunClick() {
        navigate("/knowleeagents", { state: { option: PANEL_OPTIONS.VIDEO_INTERPRETER } });
    }
            ...
            <Flex justifyContent="space-between" alignItems="center">
                <Box color={textColor}>
                    ...
                    <Text
                        ...
                        lineHeight="18px"
                    >
                        Knowlee can understand, give him a video 📹 
                    </Text>
                </Box>
            </Flex>
        </Box>
...
export default VideoInterpreterAgentCard;
