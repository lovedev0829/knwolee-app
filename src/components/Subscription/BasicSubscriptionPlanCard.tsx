...
const planMainFeatureList = [
    "GPT 4o",
    "2,000,000 chat credits",
    "Up to 500 document uploads",
    "Up to 15 Online Data Sources",
]
...
function BasicSubscriptionPlanCard({
    onUpgrade,
    isLoading,
    price,
    fullprice,
    ...
    const priceToBeShown = planDuration === "yearly" ? (price / 12 * 0.9 -10) : (price - 10);
...
export default BasicSubscriptionPlanCard